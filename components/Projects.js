    ...
    <div name="projects" className=" bg-[#0a192f] ">
      ...
      >
        ...
        <SwiperSlide className={styles.swiper__slide}>
          ...
          <h3>Tiktok Klon</h3>
          <p>
            <strong>Kullanılan Teknolojiler:</strong> React, Next.js ,Tailwind-Css , Firebase, Sanity CMS , Google Auth , React Context
          </p>
        ...
        <SwiperSlide className={styles.swiper__slide}>
          ...
          <p>
            <strong>Kullanılan Teknolojiler:</strong> React, Next.js , Redux, Sanity CMS ,Tailwind-Css , Auth0
          </p>
        ...
        <SwiperSlide className={styles.swiper__slide}>
          ...
          <h3>Twitter App</h3>
          <p>
            <strong>Kullanılan Teknolojiler:</strong> React, Next.js , Firebase,Tailwind-Css , Firebase-Authentication , React Context
          </p>
        ...
        <SwiperSlide className={styles.swiper__slide}>
          ...
          <h3>Rocorise</h3>
          <p>
            <strong>Kullanılan Teknolojiler:</strong> React, Next.js ,Tailwind-Css , Firebase
          </p>
